...
from homeassistant.const import TEMP_CELSIUS, CONF_USERNAME, CONF_PASSWORD, CONF_ACCESS_TOKEN, CONF_LONGITUDE, CONF_LATITUDE
...
def get_authentication_token(hass, credentials):
    ...
    return response[CONF_ACCESS_TOKEN]
...
def get_devices_to_sync(hass, locations, HEADERS):
    ...
    for location in locations:
        ...
        if samples:
            ...
            _LOGGER.info("No samples available for location %s", location_id)
